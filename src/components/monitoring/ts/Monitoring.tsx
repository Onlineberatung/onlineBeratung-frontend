...
import { getViewPathForType } from '../../session/ts/sessionHelpers';
import { history } from '../../app/ts/app';
import { Checkbox } from '../../checkbox/ts/Checkbox';
import { Button } from '../../button/ts/Button';
import { ajaxCallUpdateMonitoring } from '../../apiWrapper/ts';
import { ajaxCallGetMonitoring } from '../../apiWrapper/ts/ajaxCallGetMonitoring';

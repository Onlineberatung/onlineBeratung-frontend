export const enConsultingTypes = {
	consultingType: {
		...
		15: {
			...
			'groupChatRules': {
				'0': "In addiction self-help we are on first name terms, both in the groups on site and here in the chat. Anyone who has problems with this, let us know in the chat - we'll be happy to adjust!",
				'1': 'People are different, so are their opinions. Paying attention to each other as well as appreciative chat contributions guarantee a helping togetherness.',
				'2': 'Moderators have the task of ensuring that chat participants can exchange ideas. If necessary, they also offer addiction topics for discussion. Their requests are to be followed, for example if chat rules are not followed.'
			},
			'anonymous.title': 'Anonymous and free of charge',
			'welcomeScreen.anonymous.text':
				'You remain anonymous and receive free advice and help'
		...
		21: {
			...
			'welcomeScreen.anonymous.text':
				'You remain anonymous and receive free advice and help',
			'groupChatRules': {
				'0': "In self-help we are on a first name basis, both in the groups on site and here in the chat. Anyone who has problems with this, let us know in the chat - we'll be happy to adjust!",
				'1': 'People are different, so are their opinions. Paying attention to each other as well as appreciative chat contributions guarantee a helping togetherness.',
				'2': 'Moderators have the task of ensuring that chat users can exchange ideas. Their requests have to be followed, for example if chat rules are not followed.'
			}
		},
		22: {
			'titles': {

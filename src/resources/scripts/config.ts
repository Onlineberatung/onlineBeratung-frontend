...
export const config = _.merge(
	{
		...
		endpoints: {
			...
			anonymousAskerBase:
				apiUrl + '/service/conversations/askers/anonymous/',
			...
			appointmentBaseNew: (sessionId: number) =>
				apiUrl +
				`/service/appointments/sessions/${sessionId}/enquiry/new`,
			...
			counselorToken:
				apiUrl + `/service/appointservice/consultants/token`,
			...
			attachmentUploadFeedbackRoom:
				apiUrl + '/service/uploads/feedback/new/',
			...
			consultantsLanguages:
				apiUrl + '/service/users/consultants/languages',
		...
		twofactor: {
			startObligatoryHint: '2022-07-31',
			dateTwoFactorObligatory: '2022-10-01',
			messages: [
				{

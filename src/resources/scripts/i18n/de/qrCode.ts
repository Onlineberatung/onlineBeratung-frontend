const qrCode = {
	'download.filename.agency': 'qr-code-beratungsstelle',
	'download.filename.personal': 'qr-code-kontaktlink',
	...
	'agency.overlay.info.2':
		'zu registrieren. Alternativ können Sie den Code auch herunterladen.',

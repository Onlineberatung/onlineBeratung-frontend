const walkthroughInformal = {
	...
	'step.1':
		'Von hier aus kannst Du einen Chat mit einem/einer Ratsuchenden beginnen, der/die sich gerade im Warteraum befindet. Die Ratsuchenden werden mit einem anonymen Namen gekennzeichnet, ' +
		'wie zum Beispiel "Ratsuchende_r 11". Wenn Du den Chat starten möchtest, klicke auf "Chat starten" und Du kannst das Gespräch unter der Rubrik "Meine Nachrichten" fortsetzen.',
	'step.2':
	...
	'step.3':
		'Damit Du nicht durch nicht aktive Unterhaltungen abgelenkt wirst, kannst Du einige der Unterhaltungen archivieren. Sie werden dann nicht gelöscht, sondern nur in die Registerkarte ' +
		'"Archiv" verschoben. Jedes Mal, wenn Du oder der/die Ratsuchende etwas in eine archivierte Unterhaltung schreiben, ' +

const videoCallInformal = {
	...
	'overlay.unsupported.copy':
		'Dein Gerät erfüllt nicht alle nötigen technischen Vorgaben für einen Video-Call. Bitte folge dieser Anleitung um telefonieren zu können. Dafür brauchst Du möglicherweise die Unterstützung Deiner EDV.'
};

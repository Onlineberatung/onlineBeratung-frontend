const registration = {
	...
	'agencySelection.headline': 'Beratungsstelle wählen',
	...
	'state.options.7': 'Hessen',
	'state.options.8': 'Mecklenburg-Vorpommern',
	'state.options.9': 'Niedersachsen',
	'state.options.10': 'Nordrhein-Westfalen',
	'state.options.11': 'Rheinland-Pfalz',
	'state.options.12': 'Saarland',
	'state.options.13': 'Sachsen',

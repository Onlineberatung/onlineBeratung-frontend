...
describe('Expect that', function () {
	...
	describe('fonts', function () {
		test.fileExistsAndNotEmpty(
			config.global.dist + '/resources/fonts/icons/Icons.eot'
		);
		test.fileExistsAndNotEmpty(
			config.global.dist + '/resources/fonts/icons/Icons.ttf'
		);
		test.fileExistsAndNotEmpty(
			config.global.dist + '/resources/fonts/icons/Icons.woff'
		);
	});
	...
	describe('js', function () {
		// check existence
		test.fileExistsAndNotEmpty(
			config.global.dist + '/resources/js/scripts.all.min.js'
		);
		test.fileExistsAndNotEmpty(
			config.global.dist + '/resources/js/scripts.head.all.min.js'
		);
		test.fileExistsAndNotEmpty(
			config.global.dist + '/resources/js/vendor/modernizr.js'
		);
		test.fileExistsAndNotEmpty(
			config.global.dist + '/resources/js/handlebars.helper.js'
		);
	});
	...
	describe('css', function () {
		...
		test.fileExistsAndNotEmpty(
			config.global.dist + '/resources/css/styles.print.min.css'
		);
	});
});
